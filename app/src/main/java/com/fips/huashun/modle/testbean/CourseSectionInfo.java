...
public class CourseSectionInfo {
  ...
  public static class DataBeanX {
    ...
    public static class SectionBean {
       ...
       * pricetype :
       * riokin :
       * sectionname : 海盗、护士，与其他叛逆的设计师
       * sessionfile :
       * sessioninfo :
       * sessiontime :
       * sessiontype : 2
       * sessonid : 330
       * stanquality : http://v1.52qmct.com/test/2016120613211511.mp4
       * superquality :
       * teacherid :
       * thumbnail :
       * tip :
