...
public class CustomRefreshHeader extends BaseRefreshHeader {
  ...
  @Bind(R.id.custom_refresh_img)
  ImageView mCustomRefreshImg;
  @Bind(R.id.custom_refresh_txt)
  ...
  public void setState(int state) {
    ...
    switch (state) {
      case STATE_NORMAL:
        ...
        mCustomRefreshTxt.setText("下拉刷新！");
        break;
      case STATE_RELEASE_TO_REFRESH:
        if (mState != STATE_RELEASE_TO_REFRESH) {
          mCustomRefreshTxt.setText("放开以刷新！");
        }
        break;
      case STATE_REFRESHING:
        mCustomRefreshTxt.setText("正在刷新...");
        break;
      case STATE_DONE:
        mCustomRefreshTxt.setText("刷新完成！");
        break;
      default:
    }
