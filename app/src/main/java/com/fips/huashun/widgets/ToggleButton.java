...
import com.fips.huashun.widgets.rebound.SimpleSpringListener;
...
import com.fips.huashun.widgets.rebound.SpringUtil;
...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = Color.parseColor("#8FC320");
    /**
     * 关闭颜色
     */
    private int offBorderColor = Color.parseColor("#F0F0F0");
    /**
     * 灰色带颜色
     */
    private int offColor = Color.parseColor("#F0F0F0");
    /**
     * 手柄颜色
     */
    ...
    public void setup(AttributeSet attrs) {
        ...
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_bordeWidth, borderWidth);
