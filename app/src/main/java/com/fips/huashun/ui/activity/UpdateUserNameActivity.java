 ...
 * @author 张柳 时间：2016年9月28日11:32:42
 */
public class UpdateUserNameActivity extends BaseActivity implements View.OnClickListener
{
    ...
    protected void initView()
    {
        ...
        myEditText.setText(intent.getStringExtra("userName"));
        navigationBar = (NavigationBar) findViewById(R.id.nb_updatename);
        navigationBar.setTitle("修改昵称");
        ...
        navigationBar.setListener(new NavigationBar.NavigationListener()
        {
            ...
            public void onButtonClick(int button)
            {
                ...
                {
                    String userName = myEditText.getText().toString().trim();
            ...
            public void onSuccess(JSONObject data)
            {
                ...
                try
                {
                    ...
                    if ("y".equals(suc))
                    {
                        ...
                        intentToBack.putExtra("userName",userName);
