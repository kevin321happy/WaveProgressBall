 ...
 */
public class UpdateAutographActivity extends BaseActivity implements View.OnClickListener
{
    ...
    protected void initView()
    {
        ...
        myEditText.setText(intent.getStringExtra("signature"));
        navigationBar = (NavigationBar) findViewById(R.id.nb_updatename);
        navigationBar.setTitle("修改个性签名");
            ...
            public void onSuccess(JSONObject data)
            {
                ...
                try
                {
                    ...
                    if ("y".equals(suc))
                    {
                        ...
                        intentToBack.putExtra("signature",signature);
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("UpdateAutographActivity");
    }

    @Override
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("UpdateAutographActivity");
    }
}
