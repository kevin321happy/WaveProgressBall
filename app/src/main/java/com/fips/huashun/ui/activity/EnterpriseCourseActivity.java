...
//        ToastUtil.getInstant().show(enterpriseId);
...
//        });
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent intent = new Intent(EnterpriseCourseActivity.this, CourseDetailActivity.class);
    ...
    private void initData()
    {
        ...
        HttpUtil.post(Constants.ENTERPRISE_MORE_COURSE, requestParams, new LoadJsonHttpResponseHandler(this, new LoadDatahandler()
        {
            @Override
            public void onStart()
            {
            ...
            public void onSuccess(JSONObject data)
            {
                ...
                try
                {
                    ...
                    if ("y".equals(suc))
                    {
                        list = gson.fromJson(data.getString("data"), new TypeToken<List<CourseInfo>>()
                        {
                        }.getType());
